...
abstract class PageTransformer {
  ...
  Widget transform(Widget child, TransformInfo info,List<Transaction> transaction);
}
...
class TransformerPageView extends StatefulWidget {
  ...
  const TransformerPageView({
    ...
    this.itemBuilder,
    this.pageController,
    required this.itemCount, this.transactions,
  ...
  Widget _buildItem(BuildContext context, int index) {
    return AnimatedBuilder(
      ...
      builder: (BuildContext c, Widget? w) {
        ...
        return _transformer!.transform(child, info,widget.transactions!);
      },
    );
  }
